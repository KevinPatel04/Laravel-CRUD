            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-3 col-12">
                    <div class="widget-footer">
                        ...
                        <p>Welcome to Easy Consultants Visa &amp; Services</p>
                ...
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-3 col-6">
                    <div class="widget-footer">
                        ...
                        <address>4, Ishwar Krupa,
                            <br> Vadodara, Gujarat 390016</address>
                        <p>+91 999 897 8947</p>
                        <p><a href="#">Schedule a Meeting</a>
                        <br>
                        <a href="/contact">Talk to our Expert</a></p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <a href="/">Easy Consultants</a>. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
